...
namespace _11_Task
{
    class Program
    {
         ...
         * Упътване: Сканирайте цифрите на римското число отляво надясно и ги добавяйте към сума, 
         * която първоначално е инициализирана с 0. При обработката на всяка римска цифра я взимайте с 
         * положителен или отрицателен знак в зависимост от следващата цифра (дали има по-малка или по-голяма десетична стойност).*/
