...
namespace _12_Task
{
    class Program
    {
       /*Да се напише програма, която преобразува арабските числа в римски.
         * Упътване: Имаме абсолютно аналогични съответствия на числата 10, 20, ..., 90 с тяхното представяне 
         * с римските цифри "X", "L" и "C", нали? Имаме аналогични съответствия между числата 100, 200, ..., 900 и 
         * тяхното представяне с римските цифри "C", "D" и "M" и т.н.
         * Сега сме готови да преобразуваме числото N в римска бройна система. 
         * То трябва да е в интервала [1...3999], иначе съобщаваме за грешка. Първо отделяме хилядите (N / 1000) и 
         * ги заместваме с римския им еквивалент. След това отделяме стотиците ((N / 100) % 10) и ги заместваме с 
         * римския им еквивалент и т.н.*/
